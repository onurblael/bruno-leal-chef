(function(){
  ...
  var dict = {
    pt: {
      ...
      "percurso.t3.desc": "Hotel boutique num palacete histórico, membro Relais &amp; Châteaux. Show cooking para buffet e à la carte, com técnicas de sous vide e cozinha molecular.",
    ...
    es: {
      ...
      "percurso.t3.title": "Valverde Lisboa Hotel &amp; Garden",
      "percurso.t3.place": "Lisboa",
      "percurso.t3.desc": "Hotel boutique en un palacete histórico, miembro Relais &amp; Châteaux. Show cooking para buffet y a la carta, con técnicas de sous vide y cocina molecular.",
      "percurso.t4.title": "A Taberna da Rua das Flores",
      "percurso.t4.place": "Lisboa",
